//
//  LocalPlaceARViewController.swift
//  Toruński Przewodnik
//
//  Created by Arkadiusz Stasczak on 01.08.2018.
...
class LocalPlaceARViewController: UIViewController, ARSCNViewDelegate, CLLocationManagerDelegate, MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        sceneLocationView.motionIdentifier = "viewOne"
        mapKitView.motionIdentifier = "viewTwo"
        mapKitView.transition([.fadeIn])
    ...
    @objc func handleARViewTouch() {
        mapViewHeightConstraint.constant = 175
